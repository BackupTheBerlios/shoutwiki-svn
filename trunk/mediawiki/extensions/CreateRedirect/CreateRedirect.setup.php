...
$wgExtensionCredits['specialpage'][] = array(
   ...
   'description' => 'Adds [[Special:CreateRedirect|a special page]] to easily create redirects.'
);
...
function createRedirect_AddToolboxLink() {
    ...
    // 4. Add the link!
    $finalItem = "<li><a href=\"" . $wgScript . "?title=Special:Createredirect$crTitle\">".wfMsg('createredirect')."</a></li>";
    echo $finalItem;
