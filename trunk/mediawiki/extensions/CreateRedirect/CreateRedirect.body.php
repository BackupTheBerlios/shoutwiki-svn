 ...
 *
 * This program, CreateRedirect, is Copyright © 2007 Marco Zafra. CreateRedirect is released under the GNU Lesser General Public License version 3.
 *
...
class CreateRedirect extends SpecialPage {
    function CreateRedirect() {
        ...
        wfLoadExtensionMessages('CreateRedirect');
